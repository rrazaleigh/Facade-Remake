...
const BEAT_GRAPH = {
	"arrival": [
		{ "dylan_hostility_min": 15, "to": "game_over_kicked_out" },
		{ "turn_min": 6, "to": "small_talk" },
	],
	"small_talk": [
		{ "dylan_hostility_min": 12, "to": "hostile_undercurrents" },
		{ "turn_min": 6, "jasmine_suspicion_max": 15, "to": "no_drama" },
		{ "jasmine_suspicion_min": 17, "to": "cracks_showing" },
	...
	"cracks_showing": [
		{ "dylan_hostility_min": 12, "to": "hostile_undercurrents" },
		{ "jasmine_suspicion_min": 20, "to": "jasmine_feels_it" },
		{ "dylan_mask_min": 25, "to": "no_drama" },
		{ "turn_min": 8, "to": "jasmine_feels_it" },
	],
	"jasmine_feels_it": [
		{ "dylan_hostility_min": 15, "to": "hostile_undercurrents" },
		{ "jasmine_suspicion_min": 30, "to": "ending_jasmine_leaves" },
		{ "dylan_hope_min": 25, "to": "personal_growth" },
		{ "dylan_attachment_min": 30, "to": "confession" },
		{ "turn_min": 10, "to": "confession" },
	],
	"hostile_undercurrents": [
		{ "dylan_hostility_min": 25, "to": "hostile_escalation" },
		{ "dylan_trust_min": 22, "jasmine_suspicion_max": 17, "to": "jasmine_feels_it" },
		{ "turn_min": 8, "to": "hostile_escalation" },
	],
	"hostile_escalation": [
		{ "dylan_hostility_min": 40, "to": "game_over_kicked_out" },
		{ "dylan_trust_max": 10, "dylan_hope_max": 10, "to": "ending_dark" },
		{ "dylan_trust_min": 20, "to": "confession" },
		{ "dylan_hope_min": 20, "to": "personal_growth" },
		{ "turn_min": 8, "to": "confession" },
	],
	"confession": [
		{ "dylan_attachment_min": 35, "to": "ending_return_to_past" },
		{ "dylan_hope_min": 25, "dylan_trust_min": 20, "to": "ending_new_beginnings" },
		{ "dylan_hope_max": 12, "dylan_trust_max": 12, "to": "ending_toxic_spiral" },
		{ "turn_min": 8, "to": "ending_new_beginnings" },
	],
	"personal_growth": [
		{ "dylan_trust_min": 30, "to": "ending_honest_growth" },
		{ "dylan_hope_min": 25, "to": "ending_new_beginnings" },
		{ "jasmine_suspicion_min": 25, "to": "ending_plot_twist" },
